 ...
 function printTherapy(qr, treatments, user_id, general_d, user_name, user_token, ins){
 	 	 var url = "/users/"+user_id+"/diagnostics"
         var qr_c =  $(qr).html();
